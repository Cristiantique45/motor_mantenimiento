...
SECRET_KEY = 'django-insecure-qb0)3#n8(hhtdmo@@n%6&!n_p@n3u_=1j+qb%=jr(5@yce$9_%'
...
# Carpeta donde estarán los archivos estáticos en desarrollo
STATICFILES_DIRS = [
    BASE_DIR / "static",
]
